...
#if defined(LOCKTYPE)
typedef uint32_t ptlock_t;	/* change the type accorind to the lock you want to use */
...
typedef pthread_mutex_t ptlock_t;	/* change the type accorind to the lock you want to use */
